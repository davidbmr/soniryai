...
function LookFor({ nextStep }: LookForProps) {
	const [selectedRitmo, setSelectedRitmo] = useState<Option>(null);
	const [selectedGeneros, setSelectedGeneros] = useState<string[]>([]);
	const [selectedFinal, setSelectedFinal] = useState<Option>(null);
	...
	return (
		<div className={style.main__container}>
			...
			<div className={style.container__text}>
				<h2>LOOK FOR</h2>
				<p>
					¿Qué es lo que uno busca en las cosas? al elegir una película, al decidir algo... Al decir
					algo, ¿cómo llega a eso?
				</p>
			</div>
