...
function LookFor({ nextStep, formData }: LookForProps) {
    const [selections, setSelections] = useState<SelectionState>(formData);
        ...
        <div className={style.main__container}>
            ...
            <div className={style.container__white}>
                ...
                <div className={style.container__button}>
                    <button className={style.submitButton} onClick={handleNext}>
                        Continuar
                    </button>
                </div>
            </div>
